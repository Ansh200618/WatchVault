...
export function SearchBar({
  ...
  return (
    <div className="flex items-center gap-2 bg-white dark:bg-[#111111] border border-[#E5E5E5] dark:border-[#2A2A2A] rounded-full px-4 py-3">
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-[#666666]">
      ...
      <input
        ...
        className="bg-transparent outline-none flex-1 placeholder:text-[#666666] text-[#111] dark:text-white"
        style={{ fontSize: 14 }}
      />
    </div>
  );
...
export function PosterCard({
  ...
  return (
    <button onClick={onClick} className="flex-shrink-0 text-left" style={{ width: w }}>
      <div
        className="relative overflow-hidden bg-[#E5E5E5] dark:bg-[#2A2A2A] shadow-[0_10px_24px_-12px_rgba(0,0,0,0.35)]"
        style={{ width: w, height: w * 1.4, borderRadius: 24 }}
      >
