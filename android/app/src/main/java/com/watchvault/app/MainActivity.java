...
public class MainActivity extends BridgeActivity {
    ...
    private void configureWebViewBackground() {
        ...
        getBridge().getWebView().setBackgroundColor(WATCHVAULT_SYSTEM_BAR_COLOR);
    ...
    private void configureSystemBars() {
        ...
        WindowInsetsControllerCompat compatController = WindowCompat.getInsetsController(window, window.getDecorView());
